...
function draw_text_color_outline_short(text_x, text_y, text_string) {
	draw_text_color_outline(text_x, text_y, text_string, c_white, c_white, 1.0, c_black, c_black, 1.0, 4, 8, 1.0, 1.0, 0.0);
}